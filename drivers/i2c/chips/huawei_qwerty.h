...
static unsigned short keypad_keymap_m650[KEYMAP_SIZE] = {
	...
	[KEYMAP_INDEX(3, 9)] = KEY_ENTER,	//enter
	
	[KEYMAP_INDEX(4, 0)] = KEY_VOLUMEUP,	
	[KEYMAP_INDEX(4, 1)] = KEY_SEND,	//call
	[KEYMAP_INDEX(4, 2)] = KEY_LEFTSHIFT, //aA
	[KEYMAP_INDEX(4, 3)] = KEY_EMAIL,	//@
	[KEYMAP_INDEX(4, 4)] = KEY_VOLUMEDOWN,
	[KEYMAP_INDEX(4, 5)] = KEY_SPACE,
	[KEYMAP_INDEX(4, 6)] = KEY_0,		//smaiey
	[KEYMAP_INDEX(4, 7)] = KEY_F24,		//symbol 
	[KEYMAP_INDEX(4, 8)] = 0,
	[KEYMAP_INDEX(4, 9)] = KEY_CAMERA,	//camera
};
#endif
